      ...
      <van-swipe :show-indicators="false" @change="onChange" vertical :loop="false">
        <van-swipe-item v-for="(item, index) in videoList" :key="index" class="product_swiper">
          <div class="video_container">
            <video class="video_box" width="100%" height="100%" webkit-playsinline="true" x5-playsinline="" x5-video-player-type="h5" x5-video-player-fullscreen="" playsinline preload="auto" :poster="item.cover" :src="item.url" :playOrPause="playOrPause" x-webkit-airplay="allow" x5-video-orientation="portrait" @click="pauseVideo" @ended="onPlayerEnded($event)" loop="loop"></video>
            <!-- 封面 -->
...
export default {
  ...
  data() {
    ...
    return {
      ...
      videoList: [
        {
          url: 'http://39.101.74.167:8081//upload/1.mp4',
          cover: 'http://39.101.74.167:8081//upload/1cover.png',
          follow: false,
          loveCount: 24,
          shareCount: 12,
          name: '鸡蛋',
        ...
        {
          url: 'http://39.101.74.167:8081//upload/2.mp4',
          cover: 'http://39.101.74.167:8081//upload/2cover.png',
          follow: false,
          loveCount: 28,
          shareCount: 2,
          name: '焊接',
        ...
        {
          url: 'http://39.101.74.167:8081//upload/3.mp4',
          cover: 'http://39.101.74.167:8081//upload/3cover.png',
          follow: false,
          loveCount: 28,
          shareCount: 2,
          name: '沙子',
        ...
        {
          url: 'http://39.101.74.167:8081//upload/4.mp4',
          cover: 'http://39.101.74.167:8081//upload/4cover.png',
          follow: false,
          loveCount: 28,
          shareCount: 2,
          name: '杯子',
